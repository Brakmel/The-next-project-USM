...
<body>
    ...
    <main>
        <h1>Uso de Sala Hibrida</h1>
        <h2>SISTEMA KAPTIVO</h2>
        <a href="htmls/login.php"><input type="button" value="⚙️ Revisar salas ⚙️"></a>
        <a href="htmls/documentacion.php"><input type="button" value="💾 Documentación 💾"></a>
        <a href="htmls/tutorial.php"><input type="button" value="📘 Tutorial Salas Híbridas 📘"></a>
    </main>
    ...
    <footer>
        <div class="footer_img">
            ...
            <a href="https://secure-hamlet-71570.herokuapp.com/htmls/email.php"><img class="correo" src="https://www.hidronor.cl/hidronor/wp-content/uploads/2020/11/icono-mail-desktop.png"></a>
        ...
        <div class="footer_parrafo">
            ...
            <a href="https://secure-hamlet-71570.herokuapp.com/htmls/email.php"><p>Contactarse</p></a>
            <a href="https://www.linkedin.com/in/eduardo-correa-vera-b805554a/"><p>Jefe de TI</p></a>
        </div>
    </footer>
</body>
</html>